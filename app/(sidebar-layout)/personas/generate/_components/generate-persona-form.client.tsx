    ...
    <form className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div>
        <Select
          ...
          isRequired
          label="Creator Mode"
          defaultSelectedKeys={["detailed"]}
          description="Would you like to set details or quickly generate persona?"
        >
          <SelectItem key="detailed">Detailed</SelectItem>
          <SelectItem key="prompt">Prompt</SelectItem>
        </Select>
      </div>
      ...
      <div className="col-span-full">
        ...
        >
          ...
          <SelectItem key="summarized">Short summary of the persona</SelectItem>
        </Select>
      </div>
